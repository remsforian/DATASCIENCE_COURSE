xfunction outResults = crcbqcpso(inParams,psoParams,nRuns)
...
for lpruns = 1:nRuns   
    ...
    % adjusted to normalize with colored noise
    estSig = crcbgenqcsig(inParams.dataX, 1, qcCoefs);
    estSigNorm = sqrt(innerprodpsd(estSig, estSig, inParams.sampFreq, inParams.psd));
    estSig = estSig / estSigNorm;
