...
nDim = 40; %Dimensionality of the search space
rmin = -50;% lower bound of search space coordinate
rmax = 50; %Upper bound of search space coordinate
ffparams = struct('rmin',rmin,...
                     'rmax',rmax ...
                  );
% Fitness function handle.Changed to be my (different) fitness function
fitFuncHandle = @(x) crcfitnesstest(x,ffparams);
...
rng('default')
tic;
psoOut1 = crcbpso(fitFuncHandle,nDim,struct('popSize',100));
toc;
